...
pub struct PulseOpportunityInput {
    ...
    pub realizable_ev_usd: Option<Decimal>,
...
pub enum PulseFailureCode {
    ...
    PolyTransportRejected,
    HedgeTransportRejected,
...
impl PulseFailureCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::PolyTransportRejected => "poly_transport_rejected",
            Self::HedgeTransportRejected => "hedge_transport_rejected",
